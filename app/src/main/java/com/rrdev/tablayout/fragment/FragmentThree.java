...
public class FragmentThree extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.rv_fragmentThree);
        ...
        // Grid Layout
        recyclerView.setLayoutManager(new GridLayoutManager(FragmentThree.this.getActivity(), 2));
        addData();

        //set adapter
        adapter = new RecyclerViewAdapter(FragmentThree.this.getActivity(), mItems,null);
